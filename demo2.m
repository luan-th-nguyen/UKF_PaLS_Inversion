...
dv = zeros(nD);
for i = 49:69           % 2 trianglar disturbances
    for j = 49-10:i-10
        dv(i,j) = 300;
        dv(j,i) = 300;
    end
...
set(gca,'fontsize',16);
print(10,'-dpng',['Helmholtz_model2_true']);
...
set(gca,'fontsize',16);
print(20,'-dpng',['Helmholtz_model2_true_wavefield']);
...
axis equal; xlabel('x [m]','fontsize',16); ylabel('z [m]','fontsize',16);
set(gca,'fontsize',16);
print(1,'-dpng',['Helmholtz_model2_initial']);
...
for t=2:T+1
    ...
    axis equal; xlabel('x [m]','fontsize',16); ylabel('z [m]','fontsize',16);
    set(gca,'fontsize',16);
    %print(1,'-dpng',['Helmholtz_model2_reconstructed_material_map_iter_',num2str(t-1)]);
...
print(1,'-dpng',['Helmholtz_model2_reconstructed_material_map']);
print(2,'-dpng',['Helmholtz_model2_reconstructed_objective']);
print(3,'-dpng',['Helmholtz_model2_reconstructed_observables']);
...
print(fig4,'-dpng',['Helmholtz_model2_reconstructed_observables_all']);
